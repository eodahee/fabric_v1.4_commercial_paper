...
class SignetState {
     ...
     */
    // 4개의 인자(상태, key, 해당인감의공개키, 사용횟수)
    constructor(stateClass, keyParts, publicKey, countUse) { // signet 생성자
        this.class = stateClass;
        this.key = SignetState.makeKey(keyParts);
    ...
    getSplitKey(){
        return SignetState.splitKey(this.key);
    }
    ...
    serialize() {
        return SignetState.serialize(this);
    }
