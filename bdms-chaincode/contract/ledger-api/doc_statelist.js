...
'use strict';
const DocState = require('./doc_state.js');
...
class DocStateList {
    ...
    async addState(state) {
        ...
        let data = DocState.serialize(state);
     ...
     */
    async getState(key) {
        let ledgerKey = this.ctx.stub.createCompositeKey(this.name, DocState.splitKey(key));
        let data = await this.ctx.stub.getState(ledgerKey);
        let state = DocState.deserialize(data, this.supportedClasses);
        return state;
    }
